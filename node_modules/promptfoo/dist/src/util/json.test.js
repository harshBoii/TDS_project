...
describe('JSON utilities for large data handling', () => {
    ...
    describe('safeJsonStringify', () => {
        it('should handle normal objects without modification', () => {
            ...
            const result = (0, json_1.safeJsonStringify)(normalObject);
        ...
        it('should handle circular references', () => {
            ...
            obj.circular = obj;
            const result = (0, json_1.safeJsonStringify)(obj);
        ...
        it('should handle objects gracefully', () => {
            ...
            expect(() => {
                const result = (0, json_1.safeJsonStringify)(testResult);
                expect(result).toBeDefined();
                expect(typeof result).toBe('string');
            }).not.toThrow();
        });
        it('should return undefined for other types of errors', () => {
            ...
            const result = (0, json_1.safeJsonStringify)({ test: 'data' });
    ...
    describe('summarizeEvaluateResultForLogging', () => {
        ...
        it('should create a safe summary of evaluation results', () => {
            ...
            expect(summary.failureReason).toBe(types_1.ResultFailureReason.ERROR);
