...
const defaults_2 = require("./mistral/defaults");
const defaults_3 = require("./openai/defaults");
...
async function getDefaultProviders(env) {
    ...
    if (preferAzure) {
        ...
        providers = {
            ...
            moderationProvider: defaults_3.DefaultModerationProvider,
        ...
        providers = {
            embeddingProvider: defaults_3.DefaultEmbeddingProvider, // TODO(ian): Voyager instead?
        ...
        !(await (0, util_1.hasGoogleDefaultCredentials)()) &&
        ((0, envars_1.getEnvString)('MISTRAL_API_KEY') || env?.MISTRAL_API_KEY)) {
        logger_1.default.debug('Using Mistral default providers');
        providers = {
        ...
        providers = {
            embeddingProvider: defaults_3.DefaultEmbeddingProvider,
            gradingJsonProvider: defaults_3.DefaultGradingJsonProvider,
            gradingProvider: defaults_3.DefaultGradingProvider,
            moderationProvider: defaults_3.DefaultModerationProvider,
            suggestionsProvider: defaults_3.DefaultSuggestionsProvider,
            synthesizeProvider: defaults_3.DefaultGradingJsonProvider,
        };
    }
