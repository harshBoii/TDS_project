...
exports.BEDROCK_MODEL = {
    ...
    AMAZON_NOVA: {
        params: (config, prompt, stop, modelName) => {
            ...
            try {
                ...
                if (Array.isArray(parsed)) {
                    ...
                    const { system, extractedMessages } = (0, util_3.novaParseMessages)(prompt);
        ...
        output: (config, responseJson) => (0, util_3.novaOutputFromMessage)(responseJson),
        tokenUsage: (responseJson, promptText) => {
...
exports.AWS_BEDROCK_MODELS = {
    ...
    'anthropic.claude-opus-4-20250514-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    'anthropic.claude-sonnet-4-20250514-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    ...
    'apac.anthropic.claude-sonnet-4-20250514-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    ...
    'eu.anthropic.claude-sonnet-4-20250514-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    ...
    'us.anthropic.claude-opus-4-20250514-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
    'us.anthropic.claude-sonnet-4-20250514-v1:0': exports.BEDROCK_MODEL.CLAUDE_MESSAGES,
