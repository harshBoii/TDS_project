...
export declare class GroqProvider extends OpenAiChatCompletionProvider {
    ...
    toJSON(): {
        ...
        config: {
            ...
            tools?: (import("./openai/util").OpenAiTool | import("./openai/types").OpenAiMCPTool)[];
            ...
            user?: string;
            functionToolCallbacks?: Record<import("openai").default.FunctionDefinition["name"], (arg: string) => Promise<string>>;
