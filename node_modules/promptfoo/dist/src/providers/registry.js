...
const image_2 = require("./xai/image");
exports.providerMap = [
    ...
    },
    {
        ...
        create: async (providerPath, providerOptions, context) => {
            ...
            return new index_1.AwsBedrockCompletionProvider(`${modelType}${modelName ? `:${modelName}` : ''}`, providerOptions);
        },
    },
    {
    ...
    },
    {
        ...
        create: async (providerPath, providerOptions, context) => {
            ...
            if (modelType === 'image') {
                return (0, image_2.createXAIImageProvider)(providerPath, {
                    ...providerOptions,
                    env: context.env,
                });
            }
