...
exports.XAIProvider = exports.GROK_3_MINI_MODELS = exports.XAI_CHAT_MODELS = void 0;
...
exports.GROK_3_MINI_MODELS = ['grok-3-mini-beta', 'grok-3-mini-fast-beta'];
/**
...
class XAIProvider extends chat_1.OpenAiChatCompletionProvider {
    ...
    isReasoningModel() {
        return exports.GROK_3_MINI_MODELS.includes(this.modelName);
    }
    supportsTemperature() {
        return true;
    }
    getOpenAiBody(prompt, context, callApiOptions) {
        ...
        if (searchParams) {
            result.body.search_parameters = (0, util_1.renderVarsInObject)(searchParams, context?.vars);
        }
        return result;
    }
