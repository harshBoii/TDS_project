        ...
        for (const node of currentBestNodes) {
            ...
            for (let i = 0; i < BRANCHING_FACTOR; i++) {
                ...
                if (assertToUse) {
                    ...
                    if (grader) {
                        const { grade } = await grader.getResult(newInjectVar, targetResponse.output, test || {}, gradingProvider, assertToUse && 'value' in assertToUse ? assertToUse.value : undefined);
