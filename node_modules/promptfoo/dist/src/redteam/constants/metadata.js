...
exports.DEFAULT_OUTPUT_PATH = exports.PLUGIN_PRESET_DESCRIPTIONS = exports.strategyDisplayNames = exports.strategyDescriptions = exports.pluginDescriptions = exports.categoryAliasesReverse = exports.categoryAliases = exports.categoryLabels = exports.categoryMapReverse = exports.categoryDescriptions = exports.riskCategories = exports.riskCategorySeverityMap = exports.severityDisplayNames = exports.Severity = exports.displayNameOverrides = exports.subCategoryDescriptions = void 0;
const constants_1 = require("../plugins/agentic/constants");
exports.subCategoryDescriptions = {
    [constants_1.MEMORY_POISONING_PLUGIN_ID]: 'Tests whether an agent is vulnerable to memory poisoning attacks',
    ...
    pandamonium: "[Experimental] Promptfoo's blackbox jailbreak. The latest and greatest jailbreak techniques, expertly tuned and crafted by Promptfoo's AI team.",
...
exports.displayNameOverrides = {
    [constants_1.MEMORY_POISONING_PLUGIN_ID]: 'Agentic Memory Poisoning',
    aegis: 'Aegis Dataset',
 ...
 */
exports.riskCategorySeverityMap = {
    [constants_1.MEMORY_POISONING_PLUGIN_ID]: Severity.High,
...
exports.riskCategories = {
    'Security & Access Control': [
        ...
        'pii',
        'prompt-extraction',
        constants_1.MEMORY_POISONING_PLUGIN_ID,
    ],
    'Compliance & Legal': [
        'contracts',
...
exports.categoryMapReverse = Object.entries(exports.riskCategories).reduce((acc, [category, harms]) => {
    harms.forEach((harm) => {
        acc[harm] = category;
    });
    return acc;
}, {});
exports.categoryLabels = Object.keys(exports.categoryMapReverse);
// Map from plugin name to metric name or harm category
exports.categoryAliases = {
    [constants_1.MEMORY_POISONING_PLUGIN_ID]: 'AgenticMemoryPoisoning',
    aegis: 'Aegis',
...
exports.categoryAliasesReverse = Object.entries(exports.categoryAliases).reduce((acc, [key, value]) => {
    acc[value] = key;
    return acc;
}, {});
exports.pluginDescriptions = {
    ...
    'off-topic': 'Tests whether AI systems can be manipulated to go off-topic from their intended purpose by performing tasks completely outside their domain',
...
exports.strategyDescriptions = {
    ...
    'best-of-n': 'Jailbreak technique published by Anthropic and Stanford',
    camelcase: 'Tests detection and handling of text transformed into camelCase format to potentially bypass content filters',
    ...
    morse: 'Tests detection and handling of text encoded in Morse code where letters are converted to dots and dashes to potentially bypass content filters',
    multilingual: 'Evaluates cross-language attack vector handling',
    'other-encodings': 'Collection of alternative text transformation strategies (Morse code, Pig Latin, camelCase, and emoji variation selector smuggling) for testing evasion techniques',
    pandamonium: "Promptfoo's exclusive dynamic jailbreak strategy currently in development. Note: This is an expensive jailbreak strategy with no limit on probes.",
    piglatin: 'Tests detection and handling of text transformed into Pig Latin, a language game where initial consonant clusters are moved to the end of words with "ay" added',
...
exports.PLUGIN_PRESET_DESCRIPTIONS = {
...
exports.DEFAULT_OUTPUT_PATH = 'redteam.yaml';
