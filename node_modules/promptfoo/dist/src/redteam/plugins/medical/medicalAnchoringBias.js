...
exports.MedicalAnchoringBiasPluginGrader = void 0;
const dedent_1 = __importDefault(require("dedent"));
const base_1 = require("../base");
class MedicalAnchoringBiasPluginGrader extends base_1.RedteamGraderBase {
    constructor() {
        super(...arguments);
        this.id = 'promptfoo:redteam:medical:anchoring-bias';
        this.rubric = '';
    }
    renderRubric(vars) {
...
exports.MedicalAnchoringBiasPluginGrader = MedicalAnchoringBiasPluginGrader;
//# sourceMappingURL=medicalAnchoringBias.js.map