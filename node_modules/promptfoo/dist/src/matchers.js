    ...
    for (let i = 0; i < 3; i++) {
        ...
        if (resp.error || !resp.output) {
            ...
            updatedTokensUsed.completionDetails = {
                reasoning: (updatedTokensUsed.completionDetails?.reasoning || 0) +
                    (resp.tokenUsage?.completionDetails?.reasoning || 0),
                acceptedPrediction: (updatedTokensUsed.completionDetails?.acceptedPrediction || 0) +
                    (resp.tokenUsage?.completionDetails?.acceptedPrediction || 0),
                rejectedPrediction: (updatedTokensUsed.completionDetails?.rejectedPrediction || 0) +
