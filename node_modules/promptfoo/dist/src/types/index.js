...
const EvaluateOptionsSchema = zod_1.z.object({
     ...
     */
    maxEvalTimeMs: zod_1.z.number().optional(),
});
 ...
 * ```
 */
exports.TestGeneratorConfigSchema = zod_1.z.object({
    ...
    config: zod_1.z
        ...
        zod_1.z.array(zod_1.z.union([zod_1.z.string(), zod_1.z.number(), zod_1.z.boolean()])),
        zod_1.z.record(zod_1.z.string(), zod_1.z.any()),
        zod_1.z.any(), // Allow for complex nested structures and file:// references
    ]))
        .optional(),
});
...
exports.TestSuiteConfigSchema = zod_1.z.object({
    ...
    tests: zod_1.z
        .union([
        zod_1.z.string(),
        zod_1.z.array(zod_1.z.union([zod_1.z.string(), exports.TestCaseSchema, exports.TestGeneratorConfigSchema])),
        exports.TestGeneratorConfigSchema,
    ])
        .optional(),
