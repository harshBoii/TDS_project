...
var GenAIModel = class _GenAIModel extends BaseLLM {
  client;
  modelId;
  promptId;
  parameters;
  ...
  async _generate(inputs, options, runManager) {
    ...
    const llmOutput = generations.flat().reduce(
      (acc, generation) => {
        ...
        acc.input_token_count += generation.generationInfo.input_token_count ?? 0;
        return acc;
      },
      {
...
import { load as load2 } from "@langchain/core/load";
var GenAIChatModel = class _GenAIChatModel extends BaseChatModel {
  client;
  modelId;
  promptId;
  conversationId;
  ...
  async _generate(messages, options, _runManager) {
    ...
    if (output.results.length !== 1)
      throw new InternalError("Invalid result");
