...
`;else throw new R({info:`Invalid message 'role' and 'modality' combination for model : ${this.modelName}`,cause:new Error(`role : '${i.role}' cannot have content with modality : '${l.modality}'`)})}),{role:this.modelSchema.roles[i.role],content:s}}case I:{let s="",l=[];return i.content.forEach(m=>{if(m.modality===M)s+=m.value+`
...
exports.TogetherAIEmbeddingRequestInput = qo;
